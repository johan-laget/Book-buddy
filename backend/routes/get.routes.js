...
router.get("/book/:id", auth, getBookById); // ==> http://localhost:3000/get/book/{id du livre}
router.get("/bookFilter/", auth, getBookByFilter); // ==> http://localhost:3000/get/bookFilter/?categories= {nom de la categorie}
